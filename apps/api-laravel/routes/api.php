...
Route::prefix('v1')->group(function (): void {
    ...
    Route::middleware('auth:sanctum')->group(function (): void {
        ...
        Route::prefix('tenants/{tenant_id}')->middleware('tenant')->group(function (): void {
            ...
            Route::middleware('permission:service.manage')->group(function (): void {
            ...
            Route::middleware('permission:router.manage')->group(function (): void {
            ...
            Route::middleware('permission:radius.manage')->group(function (): void {
