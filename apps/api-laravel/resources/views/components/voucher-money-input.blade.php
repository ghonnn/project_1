...
<label class="block">
    ...
    <div
        ...
        class="relative"
    >
        <span class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3 text-sm font-semibold text-gray-500">Rp</span>
        <input
            type="text"
            inputmode="numeric"
            ...
            class="w-full rounded-lg border-gray-300 pl-10 text-sm shadow-sm focus:border-emerald-500 focus:ring-emerald-500"
        />
    </div>
</label>
